...
public class ViewGuestPayForDining extends JFrame
{
	...
	private void initGUI()
	{
		...
		frameTheme.applyGeneralVisuals("AFREGNING", this, "Afregning", "Mange tak for besøget, vi håber at du<br>har nydt madoplevelsen, betalingen<br>finder sted ved kassen.");
		...
		*/
		...
		if(isPreviousViewEnabled == true)
		{
			...
			btnBack.addActionListener(event ->
			{
				...
				ViewGuestTipping previouslyOpenFrameView = new ViewGuestTipping();
		...
		ComponentGuestButtonContinue btnContinue = new ComponentGuestButtonContinue("Fortsæt og Luk", bottomPanel);
